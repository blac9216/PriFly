...
[ADR-0029](../adr/0029-admit-external-reviewed-execution-packages.md) refines PF-PLN/PF-PLAN/PF-API authority and artifact ingestion without changing their engineering gates. [ADR-0030](../adr/0030-own-attempts-behind-herdr-launcher.md) refines PF-RUN/PF-SEC/PF-SCH process, socket, Docker and workspace ownership. [ADR-0031](../adr/0031-verify-remote-state-before-publication.md) refines PF-DUR/PF-REC/PF-UPG mapping, retention and lineage guarantees. Their subsystem homes own the detailed semantics; [deployment parameters](deployment-parameters.md) owns selected initial bounds, and [conformance](conformance.md) the required observations. These proposals do not certify implementation or automatically accept the earlier Proposed amendments.
