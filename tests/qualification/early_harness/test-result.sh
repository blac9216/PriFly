...
case_ "string step_deadline_ms" 'if .ev == "trace" then .step_deadline_ms |= tostring else . end' 2 "result: line 1: malformed event: trace: step_deadline_ms is not an integer >= 0"
